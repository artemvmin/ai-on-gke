...
2. Edit `workloads.tfvars` to set your project ID, location, cluster name, and GCS bucket name. Optionally, make the following changes:
    ...
    * (Recommended) Set `add_auth = true` to create a load balancer with IAP.
        * Follow the [Enable IAP Service](https://github.com/GoogleCloudPlatform/ai-on-gke/blob/main/modules/jupyter/authentication/README.MD#enable_iap_service) instructions to set up IAP.
